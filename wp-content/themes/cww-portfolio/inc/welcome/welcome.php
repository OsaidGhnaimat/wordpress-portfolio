		...
		class CWW_Welcome {
			...
			<p>
				...
				<?php if( class_exists('CWW_Companion')){ ?>
					<a class="button button-primary button-hero cww-action-btn" href="<?php echo esc_url(admin_url( 'themes.php?page=welcome-page' )) ?>"><?php esc_html_e( 'Lets Get Started', 'cww-portfolio' ); ?></a>
				<?php }else{ ?>
			...
			public function all_required_plugins_installed() {
		  	...
		  	public function get_local_dir_path($plugin) {
	      		...
	      		$url = wp_nonce_url(admin_url('themes.php?page=' . 'cww-portfolio' . '-welcome&section=actions_required'),'remote-file-installation');
